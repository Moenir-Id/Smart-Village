<?php $__env->startSection('title','Ajukan Surat'); ?>
      ...
      <div class="cb">
        <div style="padding:13px 15px;background:#f0fdf4;border-radius:9px;border:1px solid #bbf7d0;margin-bottom:16px">
          <p style="font-size:12.5px;color:#166534;margin:0">
            ...
            Data Anda (NIK, nama, foto KTP/KK) diproses oleh perangkat desa untuk penerbitan surat sesuai <strong>UU No. 27 Tahun 2022 tentang PDP</strong>. Foto dihapus otomatis <?php echo e(\App\Models\Setting::get('purge_foto_hari',30)); ?> hari setelah permohonan selesai.
          </p>
        </div>
...
<div style="text-align:center;margin-top:20px;font-size:12px;color:var(--subtle);display:flex;align-items:center;justify-content:center;gap:6px">
  ...
  Jam Pelayanan: Senin–Jumat <?php echo e(\App\Models\Setting::get('jam_kerja_buka','08:00')); ?>–<?php echo e(\App\Models\Setting::get('jam_kerja_tutup','15:00')); ?> WIB
</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.warga', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\desa\resources\views/warga/ajukan.blade.php ENDPATH**/ ?>