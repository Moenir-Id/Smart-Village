...
{{-- Dot grid + diagonal stripe pattern, warna otomatis dari tema --}}
...
<div class="hero-wrap">
  ...
  {{-- Subtitle --}}
  <p class="hero-sub">
    Sistem informasi pelayanan administrasi surat menyurat {{ $desaNama }}.
  ...
  <div style="display:flex;flex-direction:column;gap:10px;max-width:400px;margin:0 auto;width:100%">
    <a href="{{ route('warga.ajukan') }}" class="hero-btn-primary">
      <i class="bi bi-pencil-square" style="font-size:17px"></i>
      Buat Permintaan Baru
    </a>
    <div style="display:flex;gap:10px">
      <a href="{{ route('warga.ajukan') }}?tab=lacak" class="hero-btn-ghost">
  ...
  <div class="hero-stats" style="max-width:400px;margin:52px auto 0;width:100%">
    <div class="hero-stat">
      <div class="hero-stat-val"><span>{{ $totalSelesai }}</span></div>
      <div class="hero-stat-lbl">Surat Selesai</div>
    </div>
    <div class="hero-stat">
      <div class="hero-stat-val"><span>{{ $totalSurat }}</span></div>
...
{{-- Wave separator — fill pakai color-mix primer untuk blend dengan background --}}
<div class="hero-wave">
...
<div class="cara-section" id="tata-cara">
  ...
  <div class="cara-list" style="max-width:480px;margin:0 auto">
    ...
    <div class="cara-item">
      <div class="cara-num">{{ $i + 1 }}</div>
      <div>
        <p class="cara-body-title">{{ $judul }}</p>
        <p class="cara-body-desc">{{ $deskripsi }}</p>
      </div>
    </div>
    @endforeach
  </div>
  ...
  <div class="cara-cta">
    <a href="{{ route('warga.ajukan') }}" class="hero-btn-primary" style="display:inline-flex;width:auto">
  ...
  <div class="jam-chip">
    ...
    Jam Pelayanan: Senin–Jumat {{ $jamBuka }}–{{ $jamTutup }} WIB
  </div>
</div>
